...
const EventsSection: NextPage = () => {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-around bg-[#121211] py-20 md:py-0">
      ...
      <div>
        <h1 className="inter mb-12 text-5xl font-extrabold uppercase text-white md:mb-0">
          Events
        </h1>
      </div>
      <div className="grid grid-cols-1 gap-[35px] md:grid-cols-2 xl:grid-cols-3">
      ...
      <div className="inter z-20 mt-12 text-center text-xs font-bold uppercase text-white text-opacity-[35%] md:mt-0">
